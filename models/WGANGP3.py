...
class WGANGP():
    def __init__(self
        ...
        self.generator_reshape_kernel_size = generator_reshape_kernel_size
    ...
    def _build_generator(self):
        ...
        x = Conv2D(filters = 512,
                   ...
                   strides = 1,
                   use_bias = True,
                   name = 'generator_first_conv_',
                   kernel_initializer = self.weight_init)(x)
         
        scale = 2*self.generator_initial_dense_layer_size[1]

        for i in range(self.n_layers_generator):
            
            x = Reshape([scale,
                         scale,
                        self.generator_reshape_kernel_size[i]])(x)
